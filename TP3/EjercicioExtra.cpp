...
/*
Desarrollar un programa que realice las siguientes operaciones en listas de números enteros:
A. Cargar una lista insertando ordenado en forma ascendente. Finaliza con 0 (cero) que no se almacena.
B. Eliminar las ocurrencias de los números que son múltiplos de 3. Imprimir la lista antes y despues de la eliminación. 
*/
...
{
    if (inicio == nullptr || nuevoNodo -> dato < inicio -> dato) // Si la lista está vacía o el valor es menor que el primer elemento, insertar al inicio
    {
